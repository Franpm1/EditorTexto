...
/**
 * Documento con persistencia:
 * - WAL (Write-Ahead Log): guarda cada Operation antes de aplicarla.
 * - Snapshot: guarda estado completo (texto + vectorClock) cada N ops y limpia WAL.
 * - Recovery: al arrancar, carga snapshot y reproduce WAL.
 */
public class Document {
    ...
    /**
     * Guarda snapshot atómico y limpia WAL.
     */
